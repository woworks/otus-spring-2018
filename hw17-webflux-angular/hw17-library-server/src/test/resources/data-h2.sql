...
MERGE INTO books_genres (book_id, genres_id) VALUES (1, 2);
MERGE INTO books_genres (book_id, genres_id) VALUES (1, 3);
MERGE INTO books_genres (book_id, genres_id) VALUES (2, 5);
MERGE INTO books_genres (book_id, genres_id) VALUES (3, 4);
MERGE INTO books_genres (book_id, genres_id) VALUES (4, 6);
MERGE INTO books_genres (book_id, genres_id) VALUES (5, 1);
MERGE INTO books_genres (book_id, genres_id) VALUES (5, 4);
