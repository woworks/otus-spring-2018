...
import ru.otus.hw31hystrix.repository.BooksDao;
...
public class BookServiceImpl implements BookService {
    ...
    @HystrixCommand(fallbackMethod = "findDefaultAll", groupKey = "BookService", commandKey = "findAll")
    @Override
    ...
    public List<Book> findDefaultAll() {
        return Collections.emptyList();
    }
}
